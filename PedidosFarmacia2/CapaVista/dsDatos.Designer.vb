...
Namespace PedidosFarmacia2.CapaVista
    ...
    Partial Public Class dsDatos
        ...
        Partial Public Class productosDataTable
            ...
            <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
             Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
            Public Overloads Function AddproductosRow(ByVal nombre As String, ByVal tipo As String, ByVal cantidad As Integer, ByVal distribuidor As String, ByVal sucursal As String) As productosRow
                Dim rowproductosRow As productosRow = CType(Me.NewRow,productosRow)
                Dim columnValuesArray() As Object = New Object() {Nothing, nombre, tipo, cantidad, distribuidor, sucursal}
            ...
            Private Sub InitClass()
                ...
                Me.columndistribuidor.MaxLength = 15
        ...
        Partial Public Class productosRow
            ...
            Public Property distribuidor() As String
                Get
                    Return CType(Me(Me.tableproductos.distribuidorColumn),String)
                End Get
                Set
                    Me(Me.tableproductos.distribuidorColumn) = value
                End Set
            End Property
            ...
            Public Property sucursal() As String
                Get
                    Return CType(Me(Me.tableproductos.sucursalColumn),String)
                End Get
                Set
                    Me(Me.tableproductos.sucursalColumn) = value
                End Set
            End Property
        End Class
...
Namespace PedidosFarmacia2.CapaVista.dsDatosTableAdapters
    ...
    Partial Public Class productosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `productos` WHERE ((`idProducto` = @p1) AND (`nombre` = @p2) AND (`ti"& _ 
                "po` = @p3) AND (`cantidad` = @p4) AND (`distribuidor` = @p5) AND (`sucursal` = @"& _ 
                "p6))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `productos` (`nombre`, `tipo`, `cantidad`, `distribuidor`, `sucursal`"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `productos` SET `nombre` = @p1, `tipo` = @p2, `cantidad` = @p3, `distribui"& _ 
                "dor` = @p4, `sucursal` = @p5 WHERE ((`idProducto` = @p6) AND (`nombre` = @p7) AN"& _ 
                "D (`tipo` = @p8) AND (`cantidad` = @p9) AND (`distribuidor` = @p10) AND (`sucurs"& _ 
                "al` = @p11))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = "server=localhost;user id=root;database=medicamentosfarmacia"
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dsDatos.productosDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As dsDatos) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal p1 As Integer, ByVal p2 As String, ByVal p3 As String, ByVal p4 As Integer, ByVal p5 As String, ByVal p6 As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal p1 As String, ByVal p2 As String, ByVal p3 As Integer, ByVal p4 As String, ByVal p5 As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal p1 As String, ByVal p2 As String, ByVal p3 As Integer, ByVal p4 As String, ByVal p5 As String, ByVal p6 As Integer, ByVal p7 As String, ByVal p8 As String, ByVal p9 As Integer, ByVal p10 As String, ByVal p11 As String) As Integer
            If (p1 Is Nothing) Then
                Throw New Global.System.ArgumentNullException("p1")
            Else
